...
class FrameTest < Minitest::Test
  def test_calculate_score_with_bonus_strike_last_frame
    ...
    assert_equal 19, frame.calculate_score_with_bonus(frame_number, scores_for_bonus)
  end

  def test_calculate_score_with_bonus_strike_case1
    frame = Frame.new(10)
    frame_number = 3
    scores_for_bonus = [5, 3, 4, 5]

    assert_equal (10 + 5 + 3), frame.calculate_score_with_bonus(frame_number, scores_for_bonus)
  end

  def test_calculate_score_with_bonus_strike_case2
    frame = Frame.new(10)
    frame_number = 3
    scores_for_bonus = [10, 4, 5]

    assert_equal (10 + 10 + 4), frame.calculate_score_with_bonus(frame_number, scores_for_bonus)
  end
  ...
  def test_calculate_score_with_bonus_spare_case1
    ...
    assert_equal (10 + 5), frame.calculate_score_with_bonus(frame_number, scores_for_bonus)
  end
